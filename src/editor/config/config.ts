...
const config: EditorConfig = {
  ...
  icons: {
    ...
    aiEnabled:
      '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M10.705 5.38V.01h5.281v5.37h-5.281zm-5.356 7.262H8.92v3.631H5.349v-3.631zm0-5.446H8.92v3.63H5.349v-3.63zm0-5.447H8.92V5.38H5.349V1.749zM-.006 12.642h3.57v3.631h-3.57v-3.631zm0-5.446h3.57v3.63h-3.57v-3.63zm0-5.447h3.57V5.38h-3.57V1.749zm14.281 9.077h-3.57v-3.63h3.57v3.63zm1.694 7.168h-5.264v-5.352h5.264v5.352z" /></svg>',
  },
  i18n: {},
  undoManager: {},
  assetManager: {},
